...
<div class="card-dashboard p-8 mb-8">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-primary">إضافة تحديث</h2>
    ...
    <form method="POST" action="{{ force_https_route('admin.cases.updates.store', $case->id) }}" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="title" class="form-input-attorney" required placeholder="عنوان التحديث">
        </div>
        <div>
            <label class="block text-gray-700 mb-2 font-semibold">التفاصيل <span class="text-red-500">*</span></label>
            <textarea name="detail" rows="5" class="form-input-attorney" required placeholder="تفاصيل التحديث"></textarea>
        </div>
        <button type="submit" class="btn-attorney-primary">إضافة التحديث</button>
    </form>
</div>
...
<div class="card-dashboard p-8 mb-8">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">آخر التحديثات والمستجدات في القضية</p>
        </div>
    </div>
                            ...
                            <div class="flex items-start justify-between gap-4 mb-3">
                                <div class="flex items-center gap-3 flex-1">
                                    <div class="icon-circle icon-circle-sm icon-circle-solid flex-shrink-0">
                                        <span class="text-sm font-bold">{{ $case->updates->count() - $index }}</span>
                                    </div>
                                    <div class="flex-1 min-w-0">
