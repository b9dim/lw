...
<!-- Header Actions -->
<div class="mb-8">
    <a href="{{ route('admin.cases.index') }}" class="text-primary hover:text-accent font-semibold flex items-center gap-2 transition-colors duration-200 hover:underline inline-block">
...
<div class="card-dashboard p-8 mb-8">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-primary">تحديث القضية</h2>
            <p class="text-gray-500 text-sm mt-1">قم بتحديث نص آخر تحديث للقضية</p>
        </div>
    </div>
...
<div class="card-dashboard p-8">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">استفسارات العميل والردود عليها</p>
        </div>
    </div>
